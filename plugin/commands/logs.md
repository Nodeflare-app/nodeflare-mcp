...
4. `get_logs` needs a keyed request — remind the user to set `NODEFLARE_API_KEY` (free tier: 2,000,000 CU/month at https://nodeflare.app) if the call reports the method is unavailable on the public tier.
